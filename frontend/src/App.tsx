...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ allowedRoles, children }) => {
  ...
  if (allowedRoles && user?.userType && !allowedRoles.includes(user.userType)) {
    // Special case: If trying to access a seller route but user is not a seller,
    // show them the certification page instead of the unauthorized page
    if (allowedRoles.includes('SELLER') && !user.userType.includes('SELLER')) {
      return <Navigate to="/certificados" replace />;
    }
