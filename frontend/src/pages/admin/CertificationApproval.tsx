...
const CertificationApproval: React.FC = () => {
  ...
  const handleViewCertification = async (cert: Certification) => {
    try {
      ...
      const detailedCert: Certification = {
        id: fullCertificationData.id,
        userId: fullCertificationData.userId,
        certificationName: fullCertificationData.certificationName,
        certificationType: fullCertificationData.certificationType,
        imageUrl: fullCertificationData.imageUrl,
        status: fullCertificationData.status as 'PENDING' | 'VERIFIED' | 'REJECTED',
        ...
        user: {
          ...
          username: fullCertificationData.user?.username || cert.user.username,
        ...
        certificateNumber: fullCertificationData.certificateNumber,
        issuedDate: fullCertificationData.issuedDate,
        expiryDate: fullCertificationData.expiryDate,
        rejectionReason: fullCertificationData.rejectionReason
      };
  ...
  const handleApprove = async (certificationId: string) => {
    ...
    try {
      ...
      toast.success("Certificación aprobada exitosamente");
